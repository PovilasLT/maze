...
class ApiTopicsController extends Controller
{
    ...
    public function create()
    {
        ...
        return response()->json(['rules' => $createtopic->rules(), 'attributes' => $createtopic->attributes()]);
    }
    ...
    {
        $topic = Topic::with('user')->with('replies.user')->with('user.roles')->with('node')->find($id);
        if(!$topic)
        {
