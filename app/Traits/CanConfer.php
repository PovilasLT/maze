...
trait CanConfer {
	 ...
	 * 
	 * @return Collection of maze\Modules\Confer\Conversation
	 */
	...
	public function leaveConversation(\maze\Modules\Confer\Conversation $conversation)
	{
	...
	{
		return $this->hasMany('maze\Modules\Confer\Message', 'sender_id');
	}
