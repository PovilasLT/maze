...
@section('content')
	<h1>Apie Maze</h1>
	<h2>Kas yra Maze?</h2>
	<p>Maze apibrėžti kaip kažką konkretaus yra sunku. Maze yra būtybė, kurios tikslas yra suteikti "geimeriams" viską, ko  gali reikėti propoguojant šį pomėgį. Vienas iš projekto siekių yra išlaikyti kompiuterinių žaidimų žaidėjus įvykių centre, suteikti jiems sąlygas diskutuoti, tobulėti, įgyti naujus įgūdžius, mokytis ir mokyti kitus.</p>
